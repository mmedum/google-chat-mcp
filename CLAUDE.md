...
Eighteen tools, three resources:
...
- `src/app.py::build_app(settings, *, resolver=None, auth=None) -> FastMCP` — transport-agnostic. Registers all 18 tools + 3 resources, wires the `ToolContext` lifespan. Unit-tested in `tests/test_app.py`.
