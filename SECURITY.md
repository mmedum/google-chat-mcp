...
This policy covers the code in this repository. Issues in upstream dependencies (the MCP Go SDK, Google APIs, etc.) should be reported to those projects directly; we will help route when helpful.
